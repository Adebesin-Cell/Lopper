    <footer class="footer">
        <div class="container">
            <div class="footer__wrapper">
                <div class="footer__info-box footer__container">
                    <div class="footer__logo-box">
                        <a href="#" class="footer__logo-link">
                            <img src="assets/icons/logo.svg" alt="looper" class="footer__logo">
                        </a>
                    </div>
                ...
                <div class="footer__navigation footer__container">
                ...
                <div class="footer__navigation footer__container">
                    <ul class="footer__list">
                        ...
                        <li class="footer__item">
                            <a href="#" class="footer__link" name="Lorem">
                                Lorem
                            </a>
                        </li>
                        <li class="footer__item">
                            <a href="#" class="footer__link" name="Ipsum">
                                Ipsum
                            </a>
                        </li>
                        <li class="footer__item">
                            <a href="#" class="footer__link" name="Dolor">
                                Dolor
                            </a>
                        </li>
                        <li class="footer__item">
                            <a href="#" class="footer__link" name="Sit Amet">
                                Sit Amet
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="footer__contact footer__container">
                    <h1 class="footer__header">
                        <span>
                            Contact us
                        </span>
                    ...
                    <ul class="footer__list">
                        <li class="footer__item">
                            <a href="mailto:contact@lop.com" class="contact__link" name="contact@lop.com">
                ...
                <div class="footer__socials">
                    ...
                    <ul class="socials__list">
                        <li class="socials__item">
                            <a href="#" class="socials__link" name="twitter">
                        ...
                        <li class="socials__item">
                            <a href="#" class="socials__link" name="facebook">
                        ...
                        <li class="socials__item">
                            <a href="#" class="socials__link" name="medium">
                                <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
