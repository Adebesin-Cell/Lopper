...
?>
    ...
    <section class="section-about-features">
        <div class="what-we-do">
            <h1 class="what-we-do__header">
                What we do
            </h1>
            <h1 class="what-we-do__banner">
                What we do
            </h1>
        </div>
        <div class="about-features">
            <div class="about-features__wrapper">
                <div class="about-features__card">
                    <h1 class="about-features__header">
                        We build great business
                    </h1>
                    <p class="about-features__paragraph">
                ...
                <div class="about-features__card">
                    ...
                    <p class="about-features__paragraph">
                        Enim neque volutpat ac tincidunt vitae. Malesuada nunc vel risus commodo viverra maecenas accumsan lacus vel. Odio morbi quis commodo odio aenean sed adipiscing diam donec. Nisi vitae suscipit tellus mauris a.
                    </p>
                </div>
                <div class="about-features__card">
                    <h1 class="about-features__header">
        ...
        <div class="about-features__image-box">
            <img src="assets/images/features.png" alt="features" class="about-features__image">
        </div>
        <div class="about-features__overlay">
            &nbsp;
        </div>
    </section>
                ...
                <div class="clients__logos-wrapper">
                    <div class="clients__card">
                        <div class="clients__left">
                            <img src="assets/icons/codepen.svg" alt="codepen" class="clients__image">
                        </div>
                        <div class="clients__right">
                            <img src="assets/icons/dribble.svg" alt="dribble" class="clients__image">
                        </div>
                    </div>
                    <div class="clients__card">
                        <div class="clients__left">
